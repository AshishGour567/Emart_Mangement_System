...
public class RemoveEmployeesFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbEmpId.setBackground(new java.awt.Color(153, 0, 51));
        cbEmpId.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        try
        {
          ...
          if(result)
          {
             JOptionPane.showMessageDialog(null,"Recoed Deleted successfully!","Deletion Done!",JOptionPane.INFORMATION_MESSAGE);
          }
          else
